...
{
    public class JwtHandler(IConfiguration configuration, UserManager<VideoUser> userManager)
    {
        public async Task<JwtSecurityToken> GetTokenAsync(VideoUser user) =>
        new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(VideoUser user)
        {
